...
{
    public class CShopOnlineDbContext : DbContext
    {
        public CShopOnlineDbContext(DbContextOptions<CShopOnlineDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Products
            //Beauty Category
            modelBuilder.Entity<CProduct>().HasData(new CProduct
            {
                Id = 1,
            ...
            //Add users
            modelBuilder.Entity<CUser>().HasData(new CUser
            {
                Id = 1,
                UserName = "Bob"
            ...
            modelBuilder.Entity<CCart>().HasData(new CCart
            {
                Id = 1,
                UserId = 1
            ...
            modelBuilder.Entity<CProductCategory>().HasData(new CProductCategory
            {
                Id = 1,
                Name = "Beauty"
            });
        ...
        public DbSet<CCart> Carts { get; set; }
        public DbSet<CProductCategory> ProductCategories { get; set;}
    }
}
